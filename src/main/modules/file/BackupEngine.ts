...
export class BackupEngine {
  public async createFullBackup(deviceId: string, backupPath: string): Promise<string> {
    try {
...
${stdout || stderr}`;
  ...
  public async restoreBackup(deviceId: string, backupPath: string): Promise<string> {
    try {
